...
if (isset($_SESSION['userID'])) {
    ...
    $selectedMinutes = filter_input(INPUT_GET, "selectedMinutes", FILTER_VALIDATE_INT);
    ...
    if ($selectedMinutes === null || $selectedMinutes === false) {
        echo ($minutesTotal);
    } else {
        ...
        $args = [$selectedMinutes, $_SESSION["userID"]];
        $success = $stmt->execute($args);
        $minutesTotal = $minutesTotal + $selectedMinutes;
        echo ($minutesTotal);
    }
} else {
    echo (-1);
